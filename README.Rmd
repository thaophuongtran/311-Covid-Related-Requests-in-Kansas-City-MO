...
temp5melt$Keyorder = case_when(
  temp5melt$Keywords %in% c("distanc", "social","covid","pandemic","6 feet","ppe") ~ 1,
  temp5melt$Keywords %in% c("essential", "stay at home","still open","still operating","open for business","open and operating") ~ 2,
  temp5melt$Keywords %in% c("gathering", "virus","corona","quarantine") ~ 3,
  temp5melt$Keywords %in% c("mask", "positive","face cover","coverings") ~ 4
)
#plot
...
```{r word assoc, echo = FALSE, dpi = 300,fig.width=8,fig.height=3.5}
